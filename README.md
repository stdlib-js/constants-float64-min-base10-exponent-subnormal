...
```javascript
FLOAT64_MIN_BASE10_EXPONENT_SUBNORMAL = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-float64-min-base10-exponent-subnormal@v0.2.1-umd/browser.js' )
```
...
[coverage-url]: https://codecov.io/github/stdlib-js/constants-float64-min-base10-exponent-subnormal?branch=v0.2.1
